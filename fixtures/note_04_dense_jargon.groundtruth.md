...
- Keep following the eating plan and strength training.
- Return in 90 days for repeat labs.

## Plain-language expectations (reviewer judgment)
- Technical terms should be rendered for a patient: HOMA-IR / insulin
...
- No invented lab values or targets beyond what's stated.
